...
function initDB(m, client) {
  ...
  settings.id ??= ''
  settings.nameid ??= "K̴A̴O̴R̴I̴ ̴B̴O̴T̴"
  settings.type ??= 'Owner'
  settings.link ??= 'https://api.stellarwa.xyz'
  settings.banner ??= 'https://imagenes-one.vercel.app/banner.jpg'
  settings.icon ??= 'https://imagenes-one.vercel.app/icono.jpg'
  settings.currency ??= 'Yenes'
  settings.namebot ??= 'kaori'
  settings.botname ??= 'kaori miyazono'  
  settings.owner ??= '5491138403093'
